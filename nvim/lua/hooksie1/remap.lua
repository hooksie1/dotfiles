...
vim.keymap.set("t", "<C-t>", [[<C-\><C-N>:ToggleTerm size=40 dir=. hidden=true direction=float<cr>]])
vim.keymap.set("i", "<C-t>", [[<C-\><C-N>:ToggleTerm size=40 dir=. hidden=true direction=float<cr>]])
